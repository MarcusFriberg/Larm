...
// PhoneWithAlarmButton, belongs to only one room-object. Will answer true
// to the central units request if the alarm button has been pressed.
public class PhoneWithAlarmButton extends AlarmComponent implements DetectorComponent {
    // Variables
    private String name;
    ...
    // Constructor
    public PhoneWithAlarmButton(String name, Room room) {
        super(name);
        this.room = room;
        // Add this phone with alarm button to the central units list of phones.
        this.room.getEstate().getCentralUnit().connectPhoneWithAlarmButton(this);
    }
